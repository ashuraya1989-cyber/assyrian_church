    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Intäkter</h1>
                    <p className="text-muted-foreground">Registrera och följ upp föreningens intäkter.</p>
                </div>
                <div className="flex gap-2">
                    ...
                    <Button variant="premium" onClick={() => setShowForm(true)}>
                        <Plus className="mr-2 h-4 w-4" /> Ny intäktspost
                    </Button>
                </div>
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="glass-card border-none">
                        <CardHeader className="p-4 md:p-6 flex flex-row items-center justify-between border-b">
                            <CardTitle className="text-lg">Veckovisa intäkter</CardTitle>
                            <select
                                ...
                                <table className="w-full text-sm text-left">
                                    <thead className="text-xs uppercase bg-muted/50 text-muted-foreground border-b">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3">Kategori (Avg/Gåv/Ung/And)</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y">
                                        {loading ? (
                                            ...
                                            <tr>
                                                <td colSpan={4} className="px-6 py-12 text-center text-muted-foreground">Inga intäkter registrerade.</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
                    ...
                    <Card className="glass-card border-none overflow-hidden">
                        <CardHeader className="bg-green-600 text-white">
                            <CardTitle className="text-lg flex items-center">
                                <TrendingUp className="mr-2 h-5 w-5" /> Månadssammanfattning
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="p-0">
