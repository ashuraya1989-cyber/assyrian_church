...
const translations = {
    sv: {
        ...
        "page.expenses.new": "Ny utgiftstpost",
        ...
        "form.family.error_mandatory": "Vänligen fyll i alla obligatoriska fält korrekt (markerade i rött). Personnummer måste vara 12 siffror.",
        "form.family.confirm_no_husband": "Vill du gå vidare utan att fylla i Make fältet?",
        "form.family.confirm_no_wife": "Vill du gå vidare utan att fylla i Hustru fältet?",
        "form.family.confirm_save": "Vill du spara familj i familje registret?",
        "form.family.error_save": "Ett fel uppstod vid sparande",
        "form.family.main_info": "Huvudinformation",
        "form.family.family_name": "Familje efternamn",
        ...
        "form.family.no_children": "Inga barn tillagda än. Klicka på \"Lägg till barn\" för att registrera barn.",
        "form.family.saving": "Sparar...",
        "form.family.btn_update": "Uppdatera familj",
        "form.family.btn_save": "Spara familj",
        "form.payment.error_select_family": "Vänligen välj en familj.",
        ...
        "form.payment.bank_transfer": "Bank Överföring",
        "form.payment.cash": "Kontant",
        "form.payment.other": "Annat",
        "form.payment.valid_until": "Giltig till datum",
        "form.payment.valid_desc": "Medlemskapet är giltigt fram till detta datum.",
        "form.payment.ref": "Betalningsreferens (Frivillig)",
        "form.payment.ref_placeholder": "T.ex. Swish-nummer eller kvitto-ID",
        ...
        "form.user.error_mandatory": "Vänligen fyll i alla obligatoriska fält korrekt.",
        "form.user.confirm_save": "Vill du spara användaren?",
    ...
    en: {
        ...
        "page.income.select_month": "Select a month to see the summary.",
        ...
        "page.expenses.select_month": "Select a month to see the summary.",
        ...
        "form.family.error_mandatory": "Please fill in all mandatory fields correctly (marked in red). SSN must be 12 digits.",
        "form.family.confirm_no_husband": "Do you want to proceed without filling in the Husband field?",
        "form.family.confirm_no_wife": "Do you want to proceed without filling in the Wife field?",
        "form.family.confirm_save": "Do you want to save the family in the family registry?",
        ...
        "form.family.no_children": "No children added yet. Click 'Add child' to register children.",
        ...
        "page.users.desc": "Manage your application's users and their roles/permissions.",
        "page.users.add": "Add User",
        "page.users.search": "Search by email...",
        "table.email": "Email",
        "table.role": "Role",
        "table.empty_users_search": "No users found matching your search.",
        ...
        "form.user.role_admin": "Admin",
        "form.user.role_user": "User",
        "form.user.btn_update": "Update Permissions",
        "form.user.btn_save": "Create User",
