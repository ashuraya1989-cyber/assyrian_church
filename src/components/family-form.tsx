...
export function FamilyForm({ onClose, onSuccess, initialData }: FamilyFormProps) {
    ...
    const [familyData, setFamilyData] = useState({
        ...
        make_manads_avgift: initialData?.make_manads_avgift !== undefined ? initialData.make_manads_avgift : 200,
        hustru_namn: initialData?.hustru_namn || "",
        hustru_personnummer: initialData?.hustru_personnummer || "",
        hustru_manads_avgift: initialData?.hustru_manads_avgift !== undefined ? initialData.hustru_manads_avgift : 200,
